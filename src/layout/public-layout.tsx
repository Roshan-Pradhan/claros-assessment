  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 bg-gray-50">
        <aside
          className={cn(
            "fixed top-18 left-0 z-50 w-60 transform rounded-br-2xl border-r border-gray-200 bg-gray-100 p-4 transition-transform duration-300 md:relative md:top-0 md:translate-x-0 md:rounded-br-none",
        ...
        <main className="flex-1 rounded-md p-4 shadow-primary md:m-5">
          {children}
        </main>
      </div>
    </div>
